...
import box4 from '../assets/box2.jpg';

const TicketCardBestSeller = () => {
  return (
    <div className="relative w-96 rounded-2xl overflow-hidden shadow-xl bg-black">
      ...
      {/* BEST SELLER Green Triangle Tag */}
      ...
      {/* Top Header with Orange-Red Gradient */}
      <div className="relative z-10 bg-gradient-to-r from-orange-600 to-red-500 px-6 py-4">
...
export default TicketCardBestSeller;
