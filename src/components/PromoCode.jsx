                ...
                <div className="bg-white shadow-xl rounded-2xl overflow-hidden">
                    ...
                    <div className="p-8">
                        ...
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <p className="font-semibold text-gray-900">EUR 40.19</p>
                        </div>
                        ...
                        {/* Total */}
          <div className="flex justify-end items-center mb-8 pt-4 border-t border-gray-200 space-x-4">
  <p className="text-xl font-bold text-gray-900">Total: EUR 300</p>
